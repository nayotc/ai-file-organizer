...
//     public GeminiDecision classify(FileContext fileContext, String ruleSuggestion) throws IOException, InterruptedException {
//         String prompt = buildPrompt(fileContext, ruleSuggestion);
...
//     private String buildPrompt(FileContext fileContext, String ruleSuggestion) {
//         return """
//                 You are a conservative desktop file organization assistant.

//                 Classify the downloaded file into exactly one of these categories:
//                 DOCUMENTS, PICTURES, ARCHIVES, INSTALLERS, MANUAL_REVIEW

//                 Return only valid JSON in this exact format:
//                 {
//                   "category": "DOCUMENTS | PICTURES | ARCHIVES | INSTALLERS | MANUAL_REVIEW",
//                   "targetPath": "string",
//                   "confidence": 0.0,
//                   "reason": "string",
...
//                 Rules:
//                 - Be conservative.
//                 - If uncertain, return MANUAL_REVIEW.
//                 - Never classify executables or installers as DOCUMENTS.
//                 - targetPath must be a Windows-style user folder suggestion.
...
//         return objectMapper.readValue(jsonText, GeminiDecision.class);
//     }
...
//     public GeminiDecision classifyPdf(FileContext fileContext, String extractedText) throws IOException, InterruptedException {
//     String prompt = """
//             You are a conservative desktop file organization assistant.

//             Your task is to classify a PDF document by its content.

//             Return only valid JSON in this exact format:
//             {
//               "category": "FINANCE_INVOICE | FINANCE_BANK | STUDIES_MATERIAL | STUDIES_ASSIGNMENT | WORK_CONTRACT | PERSONAL_FORM | MANUAL_REVIEW",
//               "targetPath": "string",
//               "confidence": 0.0,
//               "reason": "string",
//               "needsUserConfirmation": true
...
//             Rules:
//             - Be conservative.
//             - If the content is unclear, return MANUAL_REVIEW.
//             - Base your decision mainly on the PDF content, not only the filename.
//             - targetPath must be a Windows-style folder suggestion.
//             - Do not return markdown.
//             - Do not return explanations outside JSON.
